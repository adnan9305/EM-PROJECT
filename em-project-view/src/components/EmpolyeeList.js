  ...
  return (
    ...
    <div>
      ...
      onClick={()=> navigate("/addEmployee")}
       className="bg-slate-600 hover:text-blue-700 my-12 font-semibold px-20 py-2 rounded">Add Employee</button>
    </div>
    <div>
      <table className="shadow">
        ...
        <td className=" text-left px-6 py-4 whitespace-nowrap">{employee.name}</td>
          ...
          <td className=" text-left px-6 py-4 whitespace-nowrap">
            ...
            className='hover:text-green-500 hover:cursor-pointer px-5'
            >Edit 📝</a>
            <a
